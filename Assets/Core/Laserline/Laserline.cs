...
public class Laserline : MonoBehaviour {
    ...
    */
    ...
    protected float shapeLength; //整个线的长度
    ...
    //根据shapeTransforms或者shapePoints来判断激光的形状
    ...
    {
        return new Material(Shader.Find("LaserLine/Additive_core_higlight"));
    }
