...
public class NotificationCenter : MonoBehaviour
{
    ...
    public void PostNotification(String aName) { PostNotification(aName, null); }
    public void PostNotification(String aName, object aData) { PostNotification(new Notification(aName, aData)); }
...
public class Notification
{
    ...
    public Notification( String aName) { name = aName; data = null; }
    public Notification(String aName, object aData) {name = aName; data = aData; }
}
