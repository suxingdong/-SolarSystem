...
namespace engine {
    ...
    */
    public class StringTool {
        public static void ReadArray(ref float v, string[] arr, uint index, float default_value = 0) { v = ToFloat(arr, index, default_value); }
        public static void ReadArray(ref double v, string[] arr, uint index, double default_value = 0) { v = ToDouble(arr, index, default_value); }
        public static void ReadArray(ref int v, string[] arr, uint index, int default_value = 0) { v = ToInt(arr, index, default_value); }
        public static void ReadArray(ref uint v, string[] arr, uint index, uint default_value = 0) { v = ToUInt(arr, index, default_value); }
        public static void ReadArray(ref short v, string[] arr, uint index, short default_value = 0) { v = (short)ToInt(arr, index, default_value); }
        public static void ReadArray(ref ushort v, string[] arr, uint index, ushort default_value = 0) { v = (ushort)ToUInt(arr, index, default_value); }
        public static void ReadArray(ref bool v, string[] arr, uint index, bool default_value = false) { v = ToBool(arr, index, default_value); }
        public static void ReadArray(ref String v, string[] arr, uint index) { v = ToString(arr, index); }
        public static void ReadArray(ref String v, string[] arr, uint index, String default_value) { v = ToString(arr, index, default_value); }

        public static float ToFloat(string[] arr, uint index, float default_value=0) {
            return arr.Length > index ? ToFloat(arr[index]) : default_value;
        }

        public static double ToDouble(string[] arr, uint index, double default_value = 0) {
            return arr.Length > index ? ToDouble(arr[index]) : default_value;
        }

        public static int ToInt(string[] arr, uint index, int default_value=0) {
            return arr.Length > index ? ToInt(arr[index]) : default_value;
        }

        public static uint ToUInt(string[] arr, uint index, uint default_value=0) {
            return arr.Length > index ? ToUInt(arr[index]) : default_value;
        }

        public static bool ToBool(string[] arr, uint index, bool default_value=false) {
            return arr.Length > index ? ToInt(arr[index])!=0 : default_value;
        }

        public static bool ToBool(string txt) {
            return ToInt(txt) != 0;
        }
...
//         }
        ...
        public static Vector3 ToVector3(String text, Vector3 defaultValue) {
            string[] array = text.Split(',');
            return new Vector3(ToFloat(array, 0, defaultValue.x), ToFloat(array, 1, defaultValue.y), ToFloat(array, 2, defaultValue.z));
        }
        ...
        public static Vector3 ToVector3(string[] arr, uint x_index, uint y_index, uint z_index, Vector3 def) {
            return new Vector3(ToFloat(arr, x_index, def.x), ToFloat(arr, y_index, def.y), ToFloat(arr, z_index, def.z));
        }

        public static Vector2 ToPoint(String text) {
            string[] array = text.Split(',');
            return new Vector2(ToInt(array[0]), ToInt(array, 1));
        }
        ...
        public static float ToFloat(String text) {
            ...
            double value;
            System.Double.TryParse(text, out value);
            return (float)value;
        ...
        public static Encoding byteEncoding { get { return _byteEncoding; } set { if (value != null)_byteEncoding = value; else UtilLog.LogError("不能设解码为空对象"); } }
        ...
        public static uint[] ToArrayUInt(String str, char splitChar = ',') {
        ...
        public static int[] ToArrayInt(String str, char splitChar = ',') {
            String[] arr = str.Split(splitChar);
        ...
        public static float[] ToArrayFloat(String str, char splitChar = ',') {
            String[] arr = str.Split(splitChar);
        ...
        public static double[] ToArrayDouble(String str, char splitChar = ',') {
            String[] arr = str.Split(splitChar);
