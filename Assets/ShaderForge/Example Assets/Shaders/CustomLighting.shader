...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _node_4906 ("node_4906", Color) = (0.5,0.5,1.05,0.1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                return fixed4(_node_4906.rgb,0);
            }
            ENDCG
        }
        Pass {
